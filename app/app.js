var app = angular.module('AngularScaffold', ['ui.router','dndLists','ui.bootstrap.contextMenu', 'ngDragDrop','ngStorage','AngularScaffold.Services', 'AngularScaffold.Controllers']);
